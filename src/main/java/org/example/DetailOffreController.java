...
public class DetailOffreController {
    ...
    public void setOffreData(Offre o) {
        ...
        lblDestination.setText("📍 " + o.getDestination());
        lblRemise.setText("-" + o.getTaux_remise() + "% d'économie !");
        lblDescription.setText(o.getDescription());

        try {
            String path = "/img/" + (o.getImage_url() == null ? "default.jpg" : o.getImage_url());
            imgDetail.setImage(new Image(getClass().getResourceAsStream(path)));
